...
parser.add_argument ('--arch', help = 'Alexnet can be used if this argument specified, otherwise vgg13  will be used', type = str)
...
#choose device: either cuda or cpu
if args.GPU == 'GPU':
    device = 'cuda'
else:
    device = 'cpu'
...
def load_model (arch, hidden_units):
    if arch == 'alexnet': #setting model based on alexnet
    ...
    else: #setting model based on default vgg13 ModuleList
...
#create dictionary for model saving

...
def setup_network(structure='alexnet',dropout=0.3,hidden_units=4096, lr=0.001, device='gpu'):
...
def save_checkpoint(train_data, model = 0, path = 'checkpoint.pth', structure = 'alexnet', hidden_units = 4096, dropout = 0.3, lr = 0.001, epochs = 1):
